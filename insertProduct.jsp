...
<form class="form-inline"  method="post" action="InsertProduct" align = "center">
    ...
    <div id="inputDiv" >
        ...
        <input name="pPrice1" type="number" class="form-control" step="any" placeholder="Enter price per kg/piece" required><br/><br/>
                ...
                $(document).ready(function () {
                    $("#add").click(function () {
                        ...
                        $("#inputDiv").append('<input name="pName' + count + '" type="text"  class="form-control productAvailable" placeholder="Enter product name" onchange="onChangeFunction()"> ' +
                                ...
                                '<input name="pPrice' + count + '" type="number" step="any" class="form-control" placeholder="Enter price"> <br/><br/>');
